"""
=============================================================================
03x_train_ebm_income.py — GLASSBOX CHAMPION FOR INCOME
=============================================================================
PURPOSE:
    Trains an Explainable Boosting Machine (EBM / GA2M) exclusively for
    IncomeInvestment using the TREE VIEW of Master Dataset X (15 raw features).
...
BENCHMARK TARGET:
    XGBoost Giga-Baseline AUC = 0.8121 (02x)
...
OUTPUTS (Output/Pipeline_X/):
    03x_ebm_inc_model.pkl                  — Serialized EBM (pickle)
    03x_ebm_inc_global_explanation.html    — Interactive Shape Function dashboard
    03x_ebm_inc_feature_importance.png     — Feature importance bar chart
    03x_ebm_inc_results.json              — AUC, Brier, P, R, F1 vs XGB reference
    03x_ebm_inc_shape_functions.png        — Top 3 Shape Functions plot
=============================================================================
"""
...
N_TRIALS     = 1
C_INC        = "#27AE60"
BEST_PARAMS_PATH = os.path.join(OUT_DIR, "03x_ebm_inc_best_params.json")

print("=" * 70)
print("03x_train_ebm_income.py — EBM Glassbox (Income)")
print("=" * 70)
...
# Feature filtering: Exclude manual Age bins to use continuous 'Age'
...
# Model & Transformer
pkl_path = os.path.join(OUT_DIR, "03x_ebm_inc_model.pkl")
tr_path  = os.path.join(OUT_DIR, "03x_ebm_inc_transformer.pkl")
...
# Raw Model
raw_pkl_path = os.path.join(OUT_DIR, "03x_ebm_inc_raw_model.pkl")
...
json_path = os.path.join(OUT_DIR, "03x_ebm_inc_results.json")
...
png_path = os.path.join(OUT_DIR, "03x_ebm_inc_feature_importance.png")
fig.savefig(png_path, dpi=150, bbox_inches="tight")
plt.close(fig)
print(f"      Saved chart : {os.path.basename(png_path)}")

# --- 6b. Interactive HTML dashboard ---
html_path = os.path.join(OUT_DIR, "03x_ebm_inc_global_explanation.html")
try:
...
fig.tight_layout()
shape_path = os.path.join(OUT_DIR, "03x_ebm_inc_shape_functions.png")
...
try:
    ...
    perf_path = os.path.join(OUT_DIR, "03x_ebm_inc_performance_curves.png")
...
# ---------------------------------------------------------------------------
print("\n" + "=" * 70)
print("✅ 03x_train_ebm_income.py COMPLETE")
print("=" * 70)
print(f"\n  Target       : {TARGET}")
...
print(f"\n  Outputs → {OUT_DIR}")
for fname in [
    "03x_ebm_inc_model.pkl",
    "03x_ebm_inc_results.json",
    "03x_ebm_inc_feature_importance.png",
    "03x_ebm_inc_global_explanation.html",
    "03x_ebm_inc_shape_functions.png",
]:
