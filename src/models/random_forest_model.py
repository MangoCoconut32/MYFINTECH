"""RandomForestModel implementation for the MYFINTECH pipeline."""
...
class RandomForestModel(BaseFinanceModel):
    """Calibrated Random Forest classifier with internal 5-fold CV tuning."""
    ...
    def fit(
        ...
        logger.info("RandomForestModel: fitting on %d samples.", len(X_train))
        base_rf = RandomForestClassifier(**{**self.params, **self._fixed_params()})
