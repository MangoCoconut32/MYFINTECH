"""
=============================================================================
00x_freeze_dataset.py — DATASET FREEZER FOR PIPELINE X
=============================================================================
PURPOSE:
    This script creates Dataset_Needs_SOTA.csv — the immutable "Bible" of
    Pipeline X. It encodes the cross-validation fold assignments directly
...
OUTPUT_CSV = os.path.join(PIPELINE_X_DIR, "Dataset_Needs_SOTA.csv")
...
# ---------------------------------------------------------------------------
print("=" * 68)
print("00x_freeze_dataset.py — Pipeline X Dataset Freezer")
print("=" * 68)
...
print("\n" + "=" * 68)
print("✅ Dataset frozen. Dataset_Needs_SOTA.csv is the Pipeline X Bible.")
